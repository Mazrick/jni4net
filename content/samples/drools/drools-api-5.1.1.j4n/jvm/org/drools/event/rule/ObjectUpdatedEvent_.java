...
public final class ObjectUpdatedEvent_ {
    
    //<generated-static>
    private static system.Type staticType;
    
    public static system.Type typeof() {
        return org.drools.event.rule.ObjectUpdatedEvent_.staticType;
    }
    
    private static void InitJNI(net.sf.jni4net.inj.INJEnv env, system.Type staticType) {
        org.drools.event.rule.ObjectUpdatedEvent_.staticType = staticType;
    }
    //</generated-static>
}
...
class __ObjectUpdatedEvent extends system.Object implements org.drools.event.rule.ObjectUpdatedEvent {
    
    protected __ObjectUpdatedEvent(net.sf.jni4net.inj.INJEnv __env, long __handle) {
