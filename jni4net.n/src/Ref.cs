...
namespace net.sf.jni4net
{
    partial class Ref
    {
        ...
        public static TRef GetValue<TRef>(JNIEnv env, JniLocalHandle container)
        {
            JniLocalHandle value = env.GetObjectFieldPtr(container, fieldID);
            return Convertor.FullJ2C<TRef>(env, value);
        }
